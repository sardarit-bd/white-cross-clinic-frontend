...
export default function BoneScreenProfile() {
  return (
        ...
        <div className="bg-white shadow-sm rounded-lg p-8 md:p-10 border border-[var(--borderLight)] space-y-8">
          ...
          <div className="space-y-4 text-[var(--textDark)]">
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                <span className="font-semibold">CU:</span> 30ml aliquot from a 24 hour urine collection – state total volume
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-2 text-[var(--textDark)]">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>Calcium (24 hour Urine)</li>
              <li>Phosphate (24 hour Urine)</li>
              <li>Urea and Electrolytes</li>
              <li>Alkaline Phosphatase</li>
              <li>Protein Total (Blood)</li>
              <li>Albumin</li>
              <li>Globulin</li>
              <li>Calcium</li>
            </ul>
