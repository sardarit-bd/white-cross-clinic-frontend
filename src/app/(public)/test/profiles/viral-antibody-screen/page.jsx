...
export default function ViralAntibodyScreen() {
  return (
        ...
        <div className="bg-white shadow-sm rounded-lg p-8 md:p-10 border border-[var(--borderLight)] space-y-8">
          ...
          <div className="space-y-2 text-[var(--textDark)]">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>Measles Antibodies (IgG) Immunity</li>
              <li>Measles Antibodies (IgM)</li>
              <li>Mumps Antibodies (IgG)</li>
              <li>Mumps Antibodies (IgM)</li>
              <li>Mycoplasma pneumonia</li>
              <li>Cytomegalovirus (IgG/IgM) Antibodies</li>
              <li>Herpes simplex I/II Antibody Profile (gG)</li>
            </ul>
          </div>
