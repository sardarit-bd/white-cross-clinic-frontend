...
export default function LiverFunctionVenousSelfCollect() {
  return (
        ...
        <div className="bg-white shadow-sm rounded-lg p-8 md:p-10 border border-[var(--borderLight)] space-y-8">
          ...
          <div className="space-y-2 text-[var(--textDark)]">
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>ALT (Alanine Aminotransferase) (SGPT) – Venous only</li>
              <li>Aspartate Transaminase (AST) (SGOT) – Venous only</li>
              <li>Total Protein</li>
