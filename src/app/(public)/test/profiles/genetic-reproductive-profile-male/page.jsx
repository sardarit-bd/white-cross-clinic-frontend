...
export default function GeneticReproductiveProfileMale() {
  return (
      ...
      <div className="container mx-auto">
        <div className="bg-white shadow-sm rounded-lg p-8 md:p-10 border border-[var(--borderLight)] space-y-8">
          ...
          <div className="space-y-2 text-[var(--textDark)]">
            ...
            <p>[9] Clinical history must be provided.</p>
          </div>
          ...
          <div className="space-y-4 text-[var(--textDark)]">
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                <span className="font-semibold">H:</span> Green Vacutainer, Lithium heparin anticoagulant, 6ml
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-2 text-[var(--textDark)]">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>Chromosome Analysis (Blood)</li>
              <li>Cystic Fibrosis (139 common variants) – reflex to Poly T when required</li>
              <li>Y chromosome microdeletions – AZFa + AZFb + AZFc + SRY</li>
            </ul>
          </div>
