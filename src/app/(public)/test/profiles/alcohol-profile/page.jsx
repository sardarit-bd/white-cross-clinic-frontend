...
export default function AlcoholProfileDetail() {
    return (
            ...
            <div className="container mx-auto">
                <div className="bg-white shadow-sm rounded-lg p-8 md:p-10 border border-[var(--borderLight)] space-y-8">
                    ...
                    <div className="space-y-4 text-[var(--textDark)]">
                        ...
                        <p>
                            <span className="font-semibold">A</span> — Lavender Vacutainer,
                            EDTA anticoagulant, 4ml/6ml (6ml EDTA tubes are used for specific
                            PCR assays)
                        </p>
                        ...
                        <p>
                            <span className="font-semibold">G</span> — Grey Vacutainer,
                            Fluoride oxalate anticoagulant, 2ml/4ml
                        </p>
                    </div>
