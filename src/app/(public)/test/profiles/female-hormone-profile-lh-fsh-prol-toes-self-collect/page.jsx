...
export default function FemaleHormoneProfile() {
  return (
      ...
      <div className="container mx-auto">
        <div className="bg-white shadow-sm rounded-lg p-8 md:p-10 border border-[var(--borderLight)] space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-y-4 gap-x-12 text-[var(--textDark)]">
            ...
            <div>Self-collect kit KT445</div>

            <div className="font-semibold">Turnaround</div>
            <div>Not specified</div>

            <div className="font-semibold">Special instructions</div>
            <div>Please post self-collected samples on the same day they are taken, avoid posting over weekends and bank holidays.</div>
          </div>
          ...
          <div className="space-y-2 text-[var(--textDark)]">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>FSH (Self-collect)</li>
              <li>Luteinising Hormone (LH) (Self-collect)</li>
              <li>Prolactin (Self-collect)</li>
              <li>Oestradiol</li>
            </ul>
          </div>
