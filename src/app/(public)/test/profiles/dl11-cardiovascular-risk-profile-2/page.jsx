...
export default function DL11CardiovascularRiskProfile() {
  return (
      ...
      <div className="container mx-auto">
        <div className="bg-white shadow-sm rounded-lg p-8 md:p-10 border border-[var(--borderLight)] space-y-8">
          ...
          <div className="space-y-2 text-[var(--textDark)]">
            ...
            <p>[34] Samples must arrive in the laboratory on the same day of sample taking or contact the laboratory.</p>
          </div>
          ...
          <div className="space-y-4 text-[var(--textDark)]">
            ...
            <p>
              <span className="font-semibold">C</span> — Light blue Vacutainer, Citrate anticoagulant, 4.5ml
            </p>
          </div>
          ...
          <div className="space-y-2 text-[var(--textDark)]">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>Lipid Profile (Cholesterol, Triglycerides, HDL Cholesterol, LDL Cholesterol, Non-HDL Cholesterol)</li>
              <li>Apolipoprotein A1</li>
              <li>Apolipoprotein B</li>
              <li>Lipoprotein (a)</li>
              <li>Fibrinogen</li>
              <li>C Reactive Protein (High Sensitivity)</li>
              <li>Lp-PLA2 (PLAC) Test</li>
              <li>Homocysteine (Quantitative)</li>
            </ul>
          </div>
