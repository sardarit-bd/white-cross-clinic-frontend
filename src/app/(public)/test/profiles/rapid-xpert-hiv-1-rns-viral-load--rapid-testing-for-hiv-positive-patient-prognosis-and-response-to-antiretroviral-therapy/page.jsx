      ...
      <div className="container mx-auto">
        <div className="bg-white shadow-sm rounded-lg p-8 md:p-10 border border-[var(--borderLight)] space-y-8">
          ...
          <h1 className="text-3xl font-bold" style={{ color: "var(--brandColor)" }}>
            Rapid Xpert HIV-1 RNA Viral Load – Rapid Testing for HIV-Positive Patient Prognosis and Response To Antiretroviral Therapy
          </h1>
          ...
          <div className="space-y-2 text-[var(--textDark)]">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>HIV-1 RNA VIRAL LOAD (40 copies/ml)</li>
              <li>Sample must be received in the laboratory within 24 hours of sample taking</li>
            </ul>
          </div>
