...
export default function ALEX2AllergySelfCollect() {
  return (
      ...
      <div className="container mx-auto">
        <div className="bg-white shadow-sm rounded-lg p-8 md:p-10 border border-[var(--borderLight)] space-y-8">
          ...
          <div className="space-y-3 text-[var(--textDark)]">
            ...
            <p>
              300 allergen panels, from a single sample, supplemented by Total
              IgE, which includes pollens, mites, cat and dog, fur, insect
              venoms, moulds, yeasts, food and latex.
            </p>
          </div>
