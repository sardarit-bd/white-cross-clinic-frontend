...
export default function ViralRespiratoryPCR() {
  return (
      ...
      <div className="container mx-auto">
        <div className="bg-white shadow-sm rounded-lg p-8 md:p-10 border border-[var(--borderLight)] space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-y-4 gap-x-12 text-[var(--textDark)]">
            ...
            <div>PCR or as specified on the form</div>
          ...
          <div className="space-y-2 text-[var(--textDark)]">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>Throat swabs, nasopharyngeal aspirates</li>
              <li>Adenovirus</li>
              <li>Parainfluenza 1,2,3,4</li>
              <li>Influenza A and B</li>
              <li>Coronavirus (seasonal)</li>
              <li>SARS-CoV-2 (COVID-19)</li>
              <li>Parechovirus</li>
              <li>Rhinovirus</li>
              <li>Enterovirus</li>
              <li>Respiratory Syncytial Virus A and B</li>
