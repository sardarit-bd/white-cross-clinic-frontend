...
export default function GastrointestinalPathogenPCRProfile() {
  return (
      ...
      <div className="container mx-auto">
        <div className="bg-white shadow-sm rounded-lg p-8 md:p-10 border border-[var(--borderLight)] space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-y-4 gap-x-12 text-[var(--textDark)]">
            ...
            <div>Stool/faecal container</div>
          ...
          <div className="space-y-2 text-[var(--textDark)]">
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                <span className="font-semibold">Viruses:</span> Adenovirus 40/41, Astrovirus, Norovirus GI, Norovirus GII, Rotavirus A, Sapovirus (I, II, IV, V)
              </li>
              <li>
                <span className="font-semibold">Parasites:</span> Cyclospora cayetanensis, Cryptosporidium spp., Entamoeba histolytica, Gardia lamblia
              </li>
            </ul>
