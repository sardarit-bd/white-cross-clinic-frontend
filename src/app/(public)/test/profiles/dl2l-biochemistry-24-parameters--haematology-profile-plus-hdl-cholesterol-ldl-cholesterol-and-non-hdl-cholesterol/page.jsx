...
export default function DL2LBiochemistryHaematologyProfile() {
  return (
    <div className="w-full py-10 pt-48">
      <div className="container mx-auto">
        <div className="bg-white shadow-sm rounded-lg p-8 md:p-10 border border-[var(--borderLight)] space-y-8">
          ...
          >
            DL2L Biochemistry (24 Parameters) & Haematology Profile
          </h1>
          ...
          <div className="space-y-2 text-[var(--textDark)]">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>
                <span className="font-semibold">Haematology:</span> Full Blood Count (FBC), ESR
              </li>
              <li>
                <span className="font-semibold">Urea and Electrolytes:</span> Sodium, Potassium, Chloride, Bicarbonate, Urea, Creatinine, eGFR
              </li>
              <li>
              ...
              <li>
                <span className="font-semibold">Cardiac/Muscle Enzymes:</span> LDH, CK
              </li>
              <li>
                <span className="font-semibold">Bone Markers:</span> Calcium, Phosphate, Uric Acid (Serum)
              </li>
              <li>Glucose</li>
              <li>Triglycerides</li>
              <li>Cholesterol</li>
              <li>Iron (TIBC included)</li>
