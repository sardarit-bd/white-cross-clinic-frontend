...
export default function VonWillebrandProfile() {
  return (
      ...
      <div className="container mx-auto">
        <div className="bg-white shadow-sm rounded-lg p-8 md:p-10 border border-[var(--borderLight)] space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-y-4 gap-x-12 text-[var(--textDark)]">
            ...
            <div>
              [4] Send to the laboratory same day. [9] Clinical history must be provided. [12] Please provide one sample for each person being tested.
            </div>
          </div>
          ...
          <div className="space-y-2 text-[var(--textDark)]">
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>Von Willebrand Activity (Ristocetin Cofactor)</li>
              <li>Factor VIII Assay</li>
            </ul>
          </div>
