...
export default function ALEX2AllergyVenousSelfCollect() {
  return (
      ...
      <div className="container mx-auto">
        <div className="bg-white shadow-sm rounded-lg p-8 md:p-10 border border-[var(--borderLight)] space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-y-4 gap-x-12 text-[var(--textDark)]">
            ...
            <div>B (Serum) / B (TDL Tiny)</div>

            <div className="font-semibold">Turnaround</div>
            <div>3-4 days</div>

            <div className="font-semibold">Self-collect kit</div>
            <div>KT353</div>
          </div>
          ...
          <div className="space-y-4 text-[var(--textDark)]">
            ...
            <p>
              <span className="font-semibold">B (TDL Tiny)</span> — Gold
              Microtainer, SST, Top fill line: 400-600µL
            </p>

            <p>
              <span className="font-semibold">B</span> — Gold Vacutainer,
              SST/Gel anticoagulant, 5ml
            </p>
          </div>
          ...
          <div className="space-y-3 text-[var(--textDark)]">
            ...
            <p>
              ALEX® Allergy Explorer rapidly tests for up to 300 allergens
              simultaneously and providing a comprehensive analysis, from a very
              small sample volume. The panel of allergens includes pollen,
              mites, cat and dog fur, insect venoms, moulds and yeasts, food and
              latex, supplemented with total IgE.
            </p>
          </div>
