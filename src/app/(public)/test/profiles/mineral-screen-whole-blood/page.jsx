...
export default function MineralScreenWholeBlood() {
  return (
        ...
        <div className="bg-white shadow-sm rounded-lg p-8 md:p-10 border border-[var(--borderLight)] space-y-8">
          ...
          <div className="space-y-2 text-[var(--textDark)]">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>H – Green Vacutainer, Lithium heparin anticoagulant, 6ml</li>
            </ul>
          </div>
          ...
          <div className="space-y-2 text-[var(--textDark)]">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>Whole Blood Potassium</li>
              <li>Whole Blood Magnesium</li>
              <li>Whole Blood Calcium</li>
              <li>Whole Blood Manganese</li>
              <li>Whole Blood Zinc</li>
              <li>Whole Blood Copper</li>
              <li>Whole Blood Selenium</li>
              <li>Whole Blood Chromium</li>
            </ul>
          </div>
