...
export default function DL5LBiochemistryHaematologyProfile() {
  return (
      ...
      <div className="container mx-auto">
        <div className="bg-white shadow-sm rounded-lg p-8 md:p-10 border border-[var(--borderLight)] space-y-8">
          ...
          <h1 className="text-3xl font-bold" style={{ color: "var(--brandColor)" }}>
            DL5L Biochemistry & Haematology Postal Profile plus HDL, LDL, Non-HDL Cholesterol
          </h1>
          ...
          <div className="space-y-2 text-[var(--textDark)]">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>
                <span className="font-semibold">Haematology:</span> Full Blood Count (FBC)
              </li>
              <li>
                <span className="font-semibold">Urea and Electrolytes:</span> Urea, Creatinine, eGFR
              </li>
              <li>
                <span className="font-semibold">Liver Function Tests:</span> Bilirubin, Alkaline Phosphatase, AST, ALT, Gamma GT, Protein Total, Albumin, Globulin
              </li>
              <li>
                <span className="font-semibold">Bone Markers:</span> Calcium, Uric Acid (Serum)
              </li>
              <li>Glucose</li>
              <li>Triglycerides</li>
              <li>Cholesterol</li>
              <li className="font-semibold">Plus:</li>
            ...
            <p className="text-[var(--textDark)]">
              <strong>Note:</strong> DL5/DL5L do not include ESR and Phosphate as these results may be more affected by overnight transit times.
            </p>
          </div>
