            ...
            <section className="mx-auto w-full max-w-6xl px-5 py-14 sm:px-8 lg:px-10">
                ...
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-5 max-w-[720px] text-[15px] leading-6 sm:text-[16px]">
                        White Cross Clinic provides comprehensive blood work London services including pathology services, laboratory testing, and biomarker analysis. Results from 24 hours, discreet, professional and affordable in the heart of South Kensington.
                    </p>
                </div>
                ...
                <div className="py-8">
                    ...
                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        White Cross Clinic provides comprehensive pathology services London including private blood work, laboratory testing, and biomarker analysis across the UK. Accurate results are delivered via secure email starting from 24 hours following your sample collection. Our nurse-led team ensures every sample meets stringent clinical standards.
                    </p>

                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        No GP referral is required. Our direct-access facility allows you to either book your test in advance or walk-in directly during our opening hours.
                    </p>
                </div>
                ...
                <div className="text-center py-12">
                    ...
                    <p className="mx-auto mt-5 max-w-[720px] text-[15px] leading-6 sm:text-[16px]">
                        In-Demand Diagnostics
                    </p>

                    <h1 className="text-[32px] font-semibold leading-tight tracking-[-0.5px] text-[#555555] sm:text-[38px]">
                        Popular Blood Work London
                    </h1>

                    <p className="mx-auto mt-5 max-w-[720px] text-[15px] leading-6 sm:text-[16px]">
                        The most frequently requested laboratory testing and biomarker analysis services in London.
                    </p>
