            ...
            <section className="mx-auto w-full max-w-[1040px] px-5 py-14 sm:px-8 lg:px-10">
                ...
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-5 max-w-[720px] text-[15px] leading-6 text-[#2563b8] sm:text-[16px]">
                        Basic Hydration, B Complex (B1, B2, B3, B5 & B6) Vitamin C (7.5g) B12 (5mg) Vitamin D (300,000IU).
                    </p>
                </div>
                ...
                <div className="py-8">
                    ...
                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        Hydration maintains optimal fluid balance essential for immune function. B Complex vitamins support immune health by aiding in the production of white blood cells. Vitamin C boosts immune response, aiding in the production of antibodies. B12 supports production of red blood cells, crucial for immune function. Vitamin D regulates immune cell activity, enhancing defence against pathogens.
                    </p>
