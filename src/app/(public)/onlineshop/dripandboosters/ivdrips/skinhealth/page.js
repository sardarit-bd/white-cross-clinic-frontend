            ...
            <section className="mx-auto w-full max-w-[1040px] px-5 py-14 sm:px-8 lg:px-10">
                ...
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-5 max-w-[720px] text-[15px] leading-6 text-[#2563b8] sm:text-[16px]">
                        Basic Hydration Vitamin C, Glutathione & Biotin
                    </p>
                </div>
                ...
                <div className="py-8">
                    ...
                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        Hydration keeps skin cells hydrated, promoting elasticity and preventing dryness. Vitamin C acts as an antioxidant, reducing oxidative stress and supporting collagen synthesis for firm, youthful skin. Glutathione helps detoxify the skin, reducing blemishes and promoting a clearer complexion. Biotin supports healthy skin, hair, and nails, enhancing the overall appearance and texture of the skin.
                    </p>
