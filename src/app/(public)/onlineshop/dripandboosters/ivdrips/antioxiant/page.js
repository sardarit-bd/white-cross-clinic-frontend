            ...
            <section className="mx-auto w-full max-w-[1040px] px-5 py-14 sm:px-8 lg:px-10">
                ...
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-5 max-w-[720px] text-[15px] leading-6 text-[#2563b8] sm:text-[16px]">
                        Basic hydration, Vitamin C (7.5g) Glutathione (1.2g).
                    </p>
                </div>
                ...
                <div className="mt-8 flex justify-center">
                    <button
                        type="button"
                        className="inline-flex min-w-[132px] items-center justify-center gap-2 bg-[var(--brandColor)] px-6 py-3 text-[15px] font-medium text-white transition-all duration-200 hover:bg-[#79b900] hover:shadow-md active:scale-[0.98] cursor-pointer"
                    >
                ...
                <div className="py-8">
                    ...
                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        Vitamin C & Glutathione are both powerful antioxidants that help protect cells from oxidative stress & damage caused by free radicals. Free radicals are unstable molecules with unpaired electrons, making them highly reactive. They can form naturally during metabolic processes in the body or due to external factors like pollution, UV radiation, & smoking.
                    </p>
