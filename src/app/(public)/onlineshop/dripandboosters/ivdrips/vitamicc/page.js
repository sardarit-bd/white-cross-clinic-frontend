        ...
        <main className="min-h-screen bg-white">
            <section className="mx-auto w-full max-w-[1040px] px-5 py-14 sm:px-8 lg:px-10">
                ...
                <div className="py-8">
                    ...
                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        Vitamin C is essential for collagen synthesis, which maintains the health and repair of skin, blood vessels, bones, and connective tissue. Additionally, it acts as a powerful antioxidant, protecting cells from damage caused by free radicals and boosting the immune system.
