            ...
            <section className="mx-auto w-full max-w-[1040px] px-5 py-14 sm:px-8 lg:px-10">
                ...
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-5 max-w-[720px] text-[15px] leading-6 text-[#2563b8] sm:text-[16px]">
                        Basic Hydration, B-Complex (B1, B2, B3, B5, B6), Magnesium(1g) Biotin (5g).
                    </p>
                </div>
                ...
                <div className="py-8">
                    ...
                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        Hydration replenishes moisture to the scalp, promoting hydration essential for hair growth. B-Complex vitamins support hair follicle health, aiding in the production of keratin, a protein crucial for hair strength & vitality. Magnesium facilitates nutrient absorption, contributing to improved hair quality. Biotin promotes stronger hair by enhancing keratin infrastructure, reducing hair breakage & promotes growth.
                    </p>
