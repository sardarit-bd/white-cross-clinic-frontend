            ...
            <section className="mx-auto w-full max-w-[1040px] px-5 py-14 sm:px-8 lg:px-10">
                ...
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-5 max-w-[720px] text-[15px] leading-6 text-[#2563b8] sm:text-[16px]">
                        Basic Hydration B12 (5mg) D3 (300,000IU) B-Complex (B1, B2, B3, B5, B6) Magnesium (1g) Calcium Gluco
                    </p>
                </div>
                ...
                <div className="py-8">
                    ...
                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        Basic Hydration B12 (5mg) D3 (300,000IU) B-Complex (B1, B2, B3, B5, B6) Magnesium (1g) Calcium Gluconate 10% (10ml)
                    </p>


                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        Hydration alleviates symptoms like hot flashes & dry skin. B12 aids energy levels, combating fatigue often experienced. Vitamin D3 supports bone health, reducing the risk of osteoporosis. B-Complex vitamins alleviate mood swings & support cognitive function. Magnesium eases muscle tension & promotes relaxation, reducing irritability. Calcium Gluconate strengthens bones & muscles.
                    </p>
