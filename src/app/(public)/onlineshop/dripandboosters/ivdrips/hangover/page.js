        ...
        <main className="min-h-screen bg-white">
            <section className="mx-auto w-full max-w-[1040px] px-5 py-14 sm:px-8 lg:px-10">
                ...
                <div className="py-8">
                    ...
                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        Basic Hydration replenishes lost fluids, combating dehydration caused by alcohol consumption. Glucose provides a quick energy boost, alleviating fatigue & weakness. Vitamin C acts as an antioxidant, helping to neutralize toxins and reduce inflammation. Paracetamol relieves headache and muscle aches associated with hangovers. Together, these components aid in rehydration, energy restoration, and symptom relief, easing the discomfort.
