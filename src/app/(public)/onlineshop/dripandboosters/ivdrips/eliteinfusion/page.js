            ...
            <section className="mx-auto w-full max-w-[1040px] px-5 py-14 sm:px-8 lg:px-10">
                ...
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-5 max-w-[720px] text-[15px] leading-6 text-[#2563b8] sm:text-[16px]">
                        Basic Hydration, Glutathione (1.2g) Vitamin C (7.5g) Magnesium (1g) & Biotin (5mg)
                    </p>
                </div>
                ...
                <div className="py-8">
                    ...
                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        As the summer sun intensifies, it becomes essential to rejuvenate & replenish your body after days of festivals and endless nights. Ever wondered how celebrities maintain that 'Fresh Look' despite all the nights out & busy schedules? They prioritize hydration and wellness, alongside clean eating & exercise. But what if there was an easier way?
                    </p>
