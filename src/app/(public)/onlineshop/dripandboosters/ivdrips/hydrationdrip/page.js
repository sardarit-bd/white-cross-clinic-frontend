            ...
            <section className="mx-auto w-full max-w-[1040px] px-5 py-14 sm:px-8 lg:px-10">
                ...
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-5 max-w-[720px] text-[15px] leading-6 text-[#2563b8] sm:text-[16px]">
                        Basic Hydration, Sodium Chloride (131 mmol/L), Bicarbonate (29 mmol/L), Potassium (5 mmol/L), Calciu
                    </p>
                </div>
                ...
                <div className="py-8">
                    ...
                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        Contributes to the restoration of fluid, salts, electrolytes, and minerals within the body. Our staple Basic Hydration Drip is designed to rehydrate and refresh you, making it ideal for individuals who are dehydrated and in need of an instant extra boost.
                    </p>
