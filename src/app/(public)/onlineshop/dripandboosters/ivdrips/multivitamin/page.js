            ...
            <section className="mx-auto w-full max-w-[1040px] px-5 py-14 sm:px-8 lg:px-10">
                ...
                <div className="text-center">
                    <h1 className="text-[32px] font-semibold leading-tight tracking-[-0.5px] text-[#555555] sm:text-[38px]">
                        Multivitamin / Wellness Drip
                    </h1>

                    <p className="mx-auto mt-5 max-w-[720px] text-[15px] leading-6 text-[#2563b8] sm:text-[16px]">
                        Containing a Multivitamin, B Complex Vitamins, Glutathione, Levocarnite, Magnesium and Vitamin C
                    </p>
                </div>
                ...
                <div className="py-8">
                    ...
                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        Basic Hydration ensures optimal fluid balance. B-Complex vitamins support energy metabolism and nerve function. Vitamin C boosts immune health and collagen production. Magnesium aids muscle function and relaxation. Glutathione acts as a potent antioxidant, protecting cells from damage. Together, they promote overall health, vitality, & resilience.
                    </p>
