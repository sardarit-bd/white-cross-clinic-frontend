        ...
        <main className="min-h-screen bg-white">
            <section className="mx-auto w-full max-w-[1040px] px-5 py-14 sm:px-8 lg:px-10">
                ...
                <div className="py-8">
                    ...
                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        Contributes to; The cleansing of your liver, kidneys & intestines, promoting healthy cell function. Acetylcysteine is a vital component in the body's detoxification process, aiding in the prevention of drug side effects & neutralizing environmental toxins. Furthermore, its detoxifying, antioxidant & anti-inflammatory properties make it beneficial for other liver-related conditions.
                    </p>
