            ...
            <section className="mx-auto w-full max-w-[1040px] px-5 py-14 sm:px-8 lg:px-10">
                ...
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-5 max-w-[720px] text-[15px] leading-6 text-[#2563b8] sm:text-[16px]">
                        Vitamin D Boosters available as either a single dose of 300,000 IU or double dose of 600,000 IU
                    </p>
                </div>
                ...
                <div className="py-8">
                    ...
                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        Vitamin D booster. Administered Via a shot into the Deltoid muscle. Vitamin D promotes calcium absorption in the gut and maintains adequate serum calcium and phosphate concentrations to enable normal bone mineralization. Other roles in the body, including reduction of inflammation as well as modulation of such processes as cell growth, neuromuscular and immune function, and glucose metabolism.
                    </p>
