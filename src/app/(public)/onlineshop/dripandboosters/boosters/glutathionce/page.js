            ...
            <section className="mx-auto w-full max-w-[1040px] px-5 py-14 sm:px-8 lg:px-10">
                ...
                <div className="py-8">
                    ...
                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        Contributes to strengthening your immune system, tissue building and repair, producing chemicals and proteins that are needed by the body. Glutathione is a powerful antioxidant found in every cell in the body. Glutathione breaks down free radicals and assists in cell regeneration.
                    </p>
