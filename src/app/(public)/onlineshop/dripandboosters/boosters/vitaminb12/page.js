            ...
            <section className="mx-auto w-full max-w-[1040px] px-5 py-14 sm:px-8 lg:px-10">
                ...
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-5 max-w-[720px] text-[15px] leading-6 text-[#2563b8] sm:text-[16px]">
                        B12 Booster Injections available as single(1mg), double(2mg) or triple(5mg) doses.
                    </p>
                </div>
                ...
                <div className="py-8">
                    ...
                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        Administered as a single injection into the muscle.
                    </p>

                    <p className="mt-5 text-[15px] leading-7 text-[#555555] sm:text-[16px]">
                        It contributes to various essential functions, including energy-yielding metabolism, functioning of the nervous system, homocysteine metabolism, psychological function, red blood cell formation, and function of the immune system.
