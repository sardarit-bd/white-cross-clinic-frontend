...
const doctorMenu = [
  ...
  { title: "Write a Post", href: "/dashboard/doctor/write-post", icon: FileText },
  { title: "My Posts", href: "/dashboard/doctor/posts", icon: BookOpen },
  { title: "My Schedule", href: "/dashboard/doctor/my-schedule", icon: BriefcaseMedical },
